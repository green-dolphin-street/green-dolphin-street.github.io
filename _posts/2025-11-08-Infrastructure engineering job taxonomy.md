...
- **Key Duties:**
    ...
    - Mechanical/Cooling systems design (HVAC, CRAC, chillers, containment).
    - Physical layout (floor plans, rack layout).
...
- **Key Duties:**
    ...
    - Incident response for physical plant.
    - Physical installation (racking, stacking).
    - Cabling (patching, cross-connects).
...
- **Key Duties:**
    ...
    - Storage architecture (SAN/NAS) design.
...
- **Key Duties:**
    ...
    - Routing protocol design (e.g., BGP, OSPF).
    - IP addressing strategy (IP schema).
...
- **Key Duties:**
    ...
    - Daily configuration changes (VLANs, ACLs, firewall rules).
